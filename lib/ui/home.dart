          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                const Padding(padding: EdgeInsets.symmetric(horizontal: 20, vertical: 4), child: Divider()),
                _drawerItem('Urgent Orders'.tr, Icons.priority_high_rounded, () => Get.to(() => const UrgentOrdersPage())),
                _drawerItem('Reports'.tr, Icons.article_outlined, () => Get.to(() => const ReportsPage())),
                const Padding(padding: EdgeInsets.symmetric(horizontal: 20, vertical: 4), child: Divider()),
